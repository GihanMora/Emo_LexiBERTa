...
def make_template(f_name,in_root,out_root):
  ...
  sent_perc_qna_total = []
  for cc in df['sent_perc_presentation_CEO'].to_list():sent_perc_presentation_CEO.append(ast.literal_eval(cc))
  for cc in df['sent_perc_presentation_O_man'].to_list(): sent_perc_presentation_O_man.append(ast.literal_eval(cc))
  for cc in df['sent_perc_qna_CEO'].to_list(): sent_perc_qna_CEO.append(ast.literal_eval(cc))
  for cc in df['sent_perc_qna_Anl'].to_list(): sent_perc_qna_Anl.append(ast.literal_eval(cc))
  for cc in df['sent_perc_qna_O_man'].to_list(): sent_perc_qna_O_man.append(ast.literal_eval(cc))
  for cc in df['sent_perc_qna_total'].to_list(): sent_perc_qna_total.append(ast.literal_eval(cc))
  for cc in df['sent_perc_pres_total'].to_list(): sent_perc_pres_total.append(ast.literal_eval(cc))
  print([i[0] for i in sent_perc_presentation_CEO])
  ...
  new_df['Total_Presentation_Positive'] = [i[0] for i in sent_perc_pres_total]
  new_df['Total_Presentation_Negative'] = [i[1] for i in sent_perc_pres_total]
  ...
  # except  Exception:
  #   total_pr = {'pos':'','neg':'','lit':'','unc':'','st':'','wk':''}
  new_df['CEO_Presentation_Positive'] = [i[0] for i in sent_perc_presentation_CEO]
  new_df['CEO_Presentation_Negative'] = [i[1] for i in sent_perc_presentation_CEO]
  ...
  # except  Exception:
  #   total_pr = {'pos': '', 'neg': '', 'lit': '', 'unc': '', 'st': '', 'wk': ''}
  new_df['OtherManagers_Presentation_Positive'] = [i[0] for i in sent_perc_presentation_O_man]
  new_df['OtherManagers_Presentation_Negative'] = [i[1] for i in sent_perc_presentation_O_man]
  ...
  #   print('error')
  #   total_pr = {'pos': '', 'neg': '', 'lit': '', 'unc': '', 'st': '', 'wk': ''}
  new_df['Total_Q&A_Positive'] = [i[0] for i in sent_perc_qna_total]
  new_df['Total_Q&A_Negative'] = [i[1] for i in sent_perc_qna_total]
  ...
  # except  Exception:
  #   total_pr = {'pos': '', 'neg': '', 'lit': '', 'unc': '', 'st': '', 'wk': ''}
  new_df['CEO_Q&A_Positive'] = [i[0] for i in sent_perc_qna_CEO]
  new_df['CEO_Q&A_Negative'] = [i[1] for i in sent_perc_qna_CEO]
  ...
  # except  Exception:
  #   total_pr = {'pos': '', 'neg': '', 'lit': '', 'unc': '', 'st': '', 'wk': ''}
  new_df['OtherManagers_Q&A_Positive'] = [i[0] for i in sent_perc_qna_O_man]
  new_df['OtherManagers_Q&A_Negative'] = [i[1] for i in sent_perc_qna_O_man]
  ...
  # except  Exception:
  #   total_pr = {'pos': '', 'neg': '', 'lit': '', 'unc': '', 'st': '', 'wk': ''}
  new_df['AllAnalysts_Q&A_Positive'] = [i[0] for i in sent_perc_qna_Anl]
  new_df['AllAnalysts_Q&A_Negative'] = [i[1] for i in sent_perc_qna_Anl]
...
in_root = r"E:\Projects\Emotion_work_Gihan\Emo_LexiBERTa\use_case_earning_calls\unprocessed_results\scaled\sentence_level_with_percentages\\"
out_root = r"E:\Projects\Emotion_work_Gihan\Emo_LexiBERTa\use_case_earning_calls\unprocessed_results\scaled\sentence_level_with_percentages_templated\\"
